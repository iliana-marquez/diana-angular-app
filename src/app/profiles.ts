...
export const PROFILES: IProfile[] = [
  ...
  },
  {
    ...
    audios: [
      // { title: 'Tu me acostumbraste' , author: 'CD Alma Sin Fronteras' , src: 'assets/media/audios/cd-01.wma' },
      { title: 'Piel Canela' , author: 'CD Alma Sin Fronteras' , src: 'assets/media/audios/cd-2-piel-canela.mp3' },
      { title: 'Bésame mucho' , author: 'CD Alma Sin Fronteras' , src: 'assets/media/audios/cd-3-besame-mucho.mp3' },
      { title: 'Si nos dejan' , author: 'CD Alma Sin Fronteras' , src: 'assets/media/audios/cd-4-si-nos-dejan.mp3' },
      { title: 'Como imaginar' , author: 'CD Alma Sin Fronteras' , src: 'assets/media/audios/cd-5-como-imaginar.mp3' },
      { title: 'Quizás' , author: 'CD Alma Sin Fronteras' , src: 'assets/media/audios/cd-6-quizas.mp3' },
      { title: 'Usted' , author: 'CD Alma Sin Fronteras' , src: 'assets/media/audios/cd-7-usted.mp3' },
      { title: 'Di que no es verdad' , author: 'CD Alma Sin Fronteras' , src: 'assets/media/audios/cd-8-di-que-no-es-verdad.mp3' },
      { title: 'Un poco más' , author: 'CD Alma Sin Fronteras' , src: 'assets/media/audios/cd-9-un-poco-más.mp3' },
      { title: 'Alma, corazón y vida' , author: 'CD Alma Sin Fronteras' , src: 'assets/media/audios/cd-10-alma-corazon-y-vida.mp3' },
      { title: 'Cómo fue' , author: 'CD Alma Sin Fronteras' , src: 'assets/media/audios/cd-11-como-fue.mp3' },
      { title: 'Obsesión' , author: 'CD Alma Sin Fronteras' , src: 'assets/media/audios/cd-12-obsesion.mp3' },
      { title: 'Te extraño' , author: 'CD Alma Sin Fronteras' , src: 'assets/media/audios/cd-13-te-extrano.mp3' },
    ...
    videos: [
      ...
      { title: 'Podmoskovnye Vecera (Solovyov-Sedoi / Matusovsky)', author: 'Diana & Friends', src: 'assets/media/videos/singer-diana-podmoskovnye-vecera.mp4' },
  ...
  },
  {
    ...
    audios: [
      ...
      { title: 'Prosa - Prolog aus dem Buch "Nad Priepastou" (SK)', author: 'Maria Havranova' , src: 'assets/media/audios/audio-4-speaker-prosa-prolog-buch-maria-havranova-nad-priepastou-sk.mp3' },
      { title: 'Werbung - XXXLutz (HU)', author: 'Studio Soundfeiler' , src: 'assets/media/audios/audio-5-speaker-werbung-xxxlutz-hu.mp3' },
      { title: 'Prosa - Dialog aus dem Buch "Nad Priepastou" (SK)', author: 'Maria Havranova' , src: 'assets/media/audios/audio-6-speaker-prosa-dialog-buch-maria-havranova-nad-priepastou-sk.mp3' },
      ...
      { title: 'Prosa - Finale aus dem Buch "Nad Priepastou" (SK)', author: 'Maria Havranova' , src: 'assets/media/audios/audio-9-speaker-prosa-finale-buch-maria-havranova-nad-priepastou-sk.mp3' },
    ],
    videos: [
